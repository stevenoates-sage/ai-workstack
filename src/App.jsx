...
const INITIAL_TICKETS = [
  ...
  { id: 'AI003', Ref: 'AI-003', Type: 'POC', Title: 'Performance vs Plan Agent', AssignedTo: 'Rory', StartDate: '', EndDate: '', Capacity: 100, Status: 'POC Approved', Priority: 'Critical', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Agent to compare actual performance to plan and generate variance explanations.', BusinessValue: 'Create a consistent narrative for exec reviews.', TShirt: 'XL', NotesHistory: [] },
  { id: 'AI004', Ref: 'AI-004', Type: 'POC', Title: 'Full NCA Funnel - MQL Through Deal', AssignedTo: 'Hetal', StartDate: '', EndDate: '', Capacity: 100, Status: 'Waiting Engineering', Priority: 'High', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Unified funnel view from MQL to closed deal for NCA with conversion stages.', BusinessValue: 'Single source for funnel health and leakage points.', TShirt: 'L', NotesHistory: [] },
  { id: 'AI005', Ref: 'AI-005', Type: 'POC', Title: 'Editable Views and Narrative Builder', AssignedTo: 'Chris', StartDate: '', EndDate: '', Capacity: 60, Status: 'New Request', Priority: 'Medium', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Create editable views with human-tunable narrative output for leadership packs.', BusinessValue: 'Reduces manual deck prep and keeps insights reusable.', TShirt: 'M', NotesHistory: [] },
  { id: 'AI006', Ref: 'AI-006', Type: 'POC', Title: 'Performance Trend-Pattern-Insights Agent', AssignedTo: 'Sahil', StartDate: '', EndDate: '', Capacity: 100, Status: 'New Request', Priority: 'High', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Agent to detect trend shifts, recurring patterns, and notable outliers automatically.', BusinessValue: 'Proactive insight generation without manual slicing.', TShirt: 'L', NotesHistory: [] },
  { id: 'AI007', Ref: 'AI-007', Type: 'POC', Title: 'Deep Analytics Agent', AssignedTo: 'Chris', StartDate: '', EndDate: '', Capacity: 100, Status: 'New Request', Priority: 'High', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Advanced exploratory analytics agent with follow-up questioning and drill-through.', BusinessValue: 'Speeds up deep-dive analysis cycles.', TShirt: 'XL', NotesHistory: [] },
  { id: 'AI008', Ref: 'AI-008', Type: 'POC', Title: 'Custom Views and Narrative', AssignedTo: 'Rory', StartDate: '', EndDate: '', Capacity: 60, Status: 'New Request', Priority: 'Medium', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Custom output templates with editable narrative for different stakeholder audiences.', BusinessValue: 'Reusable storylines across weekly and monthly reviews.', TShirt: 'M', NotesHistory: [] },
  { id: 'AI009', Ref: 'AI-009', Type: 'POC', Title: 'In-Life Churn Reason Agent', AssignedTo: 'Param', StartDate: '2026-03-24', EndDate: '2026-04-25', Capacity: 90, Status: 'In Progress', Priority: 'High', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Identify and rank drivers of in-life churn. Collaborators: Pearl, Dav.', BusinessValue: 'Earlier interventions to reduce churn and protect ARR.', TShirt: 'L', NotesHistory: [] },
  { id: 'AI010', Ref: 'AI-010', Type: 'POC', Title: 'NCA Pipeline Forecasting Agent', AssignedTo: 'Hetal', StartDate: '2026-03-20', EndDate: '2026-04-24', Capacity: 80, Status: 'In Progress', Priority: 'Critical', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Agent-driven forecast model for NCA pipeline with scenario overlays.', BusinessValue: 'Improves forecast confidence and planning accuracy.', TShirt: 'L', NotesHistory: [] },
  ...
  { id: 'AI018', Ref: 'AI-018', Type: 'POC', Title: 'Productivity: Spend and Comp Effectiveness', AssignedTo: 'Patrick', StartDate: '', EndDate: '', Capacity: 0, Status: 'New Request', Priority: 'Medium', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Future workstream: evaluate spend and compensation effectiveness drivers.', BusinessValue: 'Improves budget allocation and sales productivity.', TShirt: 'L', NotesHistory: [] },
  { id: 'AI019', Ref: 'AI-019', Type: 'POC', Title: 'QDC Plan Data', AssignedTo: 'Joao', StartDate: '2026-03-17', EndDate: '2026-04-07', Capacity: 70, Status: 'In Progress', Priority: 'High', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Current workstream for QDC plan data quality and mapping. Collaborator: Piers.', BusinessValue: 'Trusted plan baseline for performance comparisons.', TShirt: 'M', NotesHistory: [] },
  { id: 'AI020', Ref: 'AI-020', Type: 'POC', Title: 'MQL Lead Source Data', AssignedTo: 'Alex H', StartDate: '2026-03-18', EndDate: '2026-04-11', Capacity: 70, Status: 'In Progress', Priority: 'High', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Current workstream to consolidate lead source lineage from MQL onward. Collaborator: Sarah R.', BusinessValue: 'Improves channel attribution confidence.', TShirt: 'M', NotesHistory: [] },
  ...
  { id: 'AI022', Ref: 'AI-022', Type: 'POC', Title: 'Executive Briefing Tool UI', AssignedTo: 'Rory', StartDate: '2026-03-14', EndDate: '2026-04-02', Capacity: 65, Status: 'In Progress', Priority: 'High', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Current workstream for executive briefing UX and output narrative controls.', BusinessValue: 'Faster, cleaner exec updates with less manual formatting.', TShirt: 'M', NotesHistory: [] },
  { id: 'AI023', Ref: 'AI-023', Type: 'POC', Title: 'Auto-Pushed Insights', AssignedTo: 'Sahil', StartDate: '2026-03-19', EndDate: '2026-04-10', Capacity: 60, Status: 'In Progress', Priority: 'Medium', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Current workstream to automate scheduled insight delivery and notifications.', BusinessValue: 'Keeps teams aligned without manual follow-up.', TShirt: 'M', NotesHistory: [] },
  ...
  { id: 'AI025', Ref: 'AI-025', Type: 'POC', Title: 'Process Improvement', AssignedTo: 'Patrick', StartDate: '2026-03-15', EndDate: '2026-04-12', Capacity: 50, Status: 'In Progress', Priority: 'Medium', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Current workstream to standardize handoffs, definitions, and review cadence.', BusinessValue: 'Reduces cycle time and rework.', TShirt: 'S', NotesHistory: [] },
  { id: 'AI026', Ref: 'AI-026', Type: 'POC', Title: 'Documentation and Governance', AssignedTo: 'Kent', StartDate: '2026-03-16', EndDate: '2026-04-15', Capacity: 55, Status: 'In Progress', Priority: 'Medium', RaisedBy: 'Rory', DateAdded: '2026-03-13', Description: 'Current workstream for governance templates, controls, and documentation. Collaborator: Sahil.', BusinessValue: 'Improves compliance readiness and repeatability.', TShirt: 'M', NotesHistory: [] }
];
