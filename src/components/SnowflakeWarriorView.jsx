...
export default function SnowflakeWarriorView({ onBack }) {
  return (
    <div className="h-full overflow-y-auto bg-gray-100 p-6 dark:bg-gray-900">
      <div className="mx-auto max-w-5xl space-y-6">
        <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Snowflake Warrior</h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            Placeholder training page. Add your Snowflake fundamentals and challenge content here.
          </p>
          <div className="mt-6 rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-6 text-sm text-gray-600 dark:border-gray-600 dark:bg-gray-700/40 dark:text-gray-300">
            ...
            <ul className="mt-2 list-disc pl-5">
              <li>Warehouse setup and role permissions</li>
              <li>Core SQL patterns for analytics</li>
              <li>Data model and performance best practices</li>
            </ul>
          </div>
          <button
            type="button"
