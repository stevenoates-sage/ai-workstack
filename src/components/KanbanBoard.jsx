...
const FLOW_STEPS = [
  ...
  { label: 'POC Approved',              color: 'bg-emerald-300',  textColor: 'text-emerald-900', desc: 'POC showcased — leadership approves for engineering' },
  ...
  { label: 'Engineering - In Progress', color: 'bg-orange-500',   textColor: 'text-white',       desc: 'On the roadmap — security, testing & production build' },
  ...
  <div className="px-4 pt-3 pb-2 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
    ...
    <div className="flex items-start gap-0 overflow-x-auto pb-1">
      {FLOW_STEPS.map((step, i) => (
        <div key={step.label} className="flex items-start min-w-0 flex-1">
          ...
          {i < FLOW_STEPS.length - 1 && (
            <div className="flex items-center px-1 flex-shrink-0 mt-2">
...
const columns = {
    ...
    'In Progress':          { title: 'Engineering - In Progress', color: 'border-t-orange-500' },
